    ...
    <div class="mycontainer">
        ...
        <section id="products">
            ...
            <div class="row" id="row2">
                <div class="col-sm-8" id="col3">

                </div>
                <div class="col-sm-4" id="col4">
                    <asp:TextBox ID="AddProductTextBox" runat="server" Height="23px" Width="167px" Text="חפש או כתוב מוצר להוספה" BackColor="#FFFF99" BorderStyle="Dotted" AutoCompleteType="Enabled" ForeColor="Red"></asp:TextBox>
                    <asp:DropDownList ID="amountDropDownList" runat="server" BackColor="#FFFF99" Height="30px" Width="40px">
                    ...
                    <asp:Button ID="AddProductButton" runat="server" Text="הוסף מוצר" Height="27px" Width="74px" BorderColor="#FFCCCC" BorderStyle="Solid" Font-Bold="True" Font-Size="Small" />
                </div>
